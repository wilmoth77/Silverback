 ...
 *      Sample HTML:
 *
 *          <!-- build .nav-tabs and .scrolling-tab-content in here -->
 ...
 *                          that go in .scrolling-tab-content. By default, the plugin
...
;(function ($, window) {
  ...
  var tabElements = (function () {
    ...
    function getNewElTabContent() {
      return $('<div class="scrolling-tab-content"></div>');
    }
  ...
  function listenForDropdownMenuTabs($scroller, stc) {
    ...
    function handleDropdownShow(e) {
      ...
      function handleClickOnDropdownMenuItem() {
        ...
        $('.scrolling-tab-content .tab-pane.active').removeClass('active');
  ...
  function refreshDataDrivenTabs($container, options) {
    var instanceData = $container.data().scrtabs,
        ...
        $currTabContentPanesContainer = $container.find('.scrolling-tab-content'),
        isInitTabsRequired = false,
        refreshData = {
          options: options,
